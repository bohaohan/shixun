        ...
        <div class="bottom-header">
            <div class="container">
                ...
                <div class="header-bottom-right">
                    <div class="account"><s:iterator value = "#request.list"><s:if test = "status=='在线'"><a href="listSingleUser.action"><span> </span><s:property value = "users.name"/>的账户</a></s:if></s:iterator></div>
                    <ul class="login">
      	   ...
      	   <div class="account_grid">
			   <div class=" login-right">
				...
				<s:form action = "listUser" >
				  <div>
					<span>邮箱地址/账户<label>*</label>
					<input type = "text" name = "users.username"/></span> 
				  </div>
				  <div>
					<span>密码<label>*</label>
					<input type = "text"  name = "users.password"/></span> 
				  </div>
