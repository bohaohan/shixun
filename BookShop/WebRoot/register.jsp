        ...
        <div class="bottom-header">
            <div class="container">
                ...
                <div class="header-bottom-right">
                    <div class="account"><a href="#"><span> </span>你的账户</a></div>
                    <ul class="login">
		...
		<div class="register">
		  	  <s:form action="saveUser" method ="post"> 
				 <div class="  register-top-grid">
					<h3>个人信息</h3>
					<div class="mation">
						真实姓名*<input type="text" name = "users.name"/> 
					
						<span>性别<label>*</label></span>
						<input type="text" name = "users.sex"/>
					 
						 <span>邮箱地址<label>*</label></span>
						 <input type="text" name = "users.email"/>
						 
						 <span>电话<label>*</label></span>
						 <input type="text" name = "users.phone"/>
						 
						 <span>生日<label>*</label></span>
						 <input type="text" name = "users.birthday"/>
						 
						 <span>地址<label>*</label></span>
						 <input type="text" name = "users.address"/>
					</div>
					 <div class="clearfix"> </div>
